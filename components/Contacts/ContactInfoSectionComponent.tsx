            ...
            <div className={styles.container}>
                <div className={styles.infoGrid}>
                    ...
                    <div className={`${styles.infoCard} animate-fade stagger-1`}>
                        ...
                        <p className={styles.cardValue}>{t.contactPage.address1}<br /><small style={{ opacity: 0.7 }}>Ориентир — трасса Алаш</small></p>
                    </div>
                    ...
                    <div className={`${styles.infoCard} animate-fade stagger-2`}>
                        ...
                        <p className={styles.cardValue}>{t.contactPage.email1}</p>
                    </div>
                    ...
                    <div className={`${styles.infoCard} animate-fade stagger-3`}>
                        ...
                        <p className={styles.cardValue}>info@malika-center.kz</p>
                    </div>
