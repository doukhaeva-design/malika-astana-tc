            ...
            <div className={styles.container}>
                <div className={styles.info}>
                    ...
                    <div className={styles.socials}>
                        ...
                        <a href="mailto:info@malika.kz" className={styles.socialIcon} aria-label="Email">
                ...
                <div className={styles.contacts}>
                    ...
                    <div className={styles.contactItem}>
                        ...
                        <span>г. Астана, район Байконур, Шоссе Алаш</span>
                    </div>
                    <div className={styles.contactItem}>
                ...
                <div className={styles.copyright}>
                    <p>&copy; {new Date().getFullYear()} MALIKA. Все права защищены.</p>
