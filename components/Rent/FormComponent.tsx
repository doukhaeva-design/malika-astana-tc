                    ...
                    <form className={styles.form} onSubmit={(e) => e.preventDefault()}>
                        <div className={styles.field}>
                            ...
                            <input
                                type="text"
                                id="name"
                                placeholder={t.rentPage.formNamePlaceholder}
                                value={name}
                        ...
                        <div className={styles.field}>
                            ...
                            <input
                                type="text"
                                id="businessType"
                                placeholder={t.rentPage.formBusinessPlaceholder}
                                value={businessType}
                        ...
                        <div className={styles.field}>
                            ...
                            <textarea
                                id="comment"
                                placeholder={t.rentPage.formMessagePlaceholder}
                                value={comment}
