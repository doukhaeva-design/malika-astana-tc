        ...
        <section className={styles.section} id="apply">
            <div className={styles.container}>
                <div className={styles.header}>
                    <h2 className={styles.title}>Интересует аренда помещения?</h2>
                ...
                <div className={styles.formWrapper}>
                    <form className={styles.form}>
                        ...
                        <div className={styles.field}>
                            <label htmlFor="email">
                                Email <span className={styles.labelNote}>— обязателен для Email-заявки</span>
                            </label>
                            <input type="email" id="email" placeholder="example@mail.com" />
                        </div>
                        <div className={styles.field}>
                            <label htmlFor="phone">
                                Телефон <span className={styles.labelNote}>(необязательно)</span>
                            </label>
                            <input type="tel" id="phone" placeholder="+7 (___) ___-__-__" />
                        </div>
                        <div className={styles.field}>
                            <label htmlFor="businessType">Тип бизнеса</label>
                            <input type="text" id="businessType" placeholder="Магазин одежды, Кофейня..." />
                        </div>
                        <div className={styles.field}>
                            <label htmlFor="comment">Ваше сообщение</label>
                            <textarea id="comment" placeholder="Какая площадь вас интересует?"></textarea>
                        </div>

                        <div className={styles.submitActions}>
                            <a href="mailto:rent@malika-center.kz" className={styles.emailBtn}>
                            ...
                            <a href="https://wa.me/+77011234567" target="_blank" rel="noopener noreferrer" className={styles.whatsappBtn}>
