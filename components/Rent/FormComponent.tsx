        ...
        <section className={styles.section} id="apply">
            <div className={styles.container}>
                <div className={styles.header}>
                    ...
                    <p className={styles.subtitle}>{t.rentPage.formSubtitle}</p>
                </div>

                <div className={styles.formWrapper}>
                    <form className={styles.form}>
                        <div className={styles.field}>
                            <label htmlFor="name">{t.rentPage.formName}</label>
                            <input type="text" id="name" placeholder={t.rentPage.formNamePlaceholder} required />
                        </div>
                        <div className={styles.field}>
                            <label htmlFor="email">
                                Email <span className={styles.labelNote}>{t.rentPage.formEmailNote}</span>
                            </label>
                            <input type="email" id="email" placeholder="example@mail.com" />
                        </div>
                        <div className={styles.field}>
                            <label htmlFor="phone">
                                {t.rentPage.formPhone} <span className={styles.labelNote}>{t.rentPage.formPhoneOptional}</span>
                            </label>
                            <input type="tel" id="phone" placeholder="+7 (___) ___-__-__" />
                        </div>
                        <div className={styles.field}>
                            <label htmlFor="businessType">{t.rentPage.formBusiness}</label>
                            <input type="text" id="businessType" placeholder={t.rentPage.formBusinessPlaceholder} />
                        </div>
                        <div className={styles.field}>
                            <label htmlFor="comment">{t.rentPage.formMessage}</label>
                            <textarea id="comment" placeholder={t.rentPage.formMessagePlaceholder}></textarea>
                        </div>
                        ...
                        <div className={styles.submitActions}>
                            ...
                            <a href="https://wa.me/77055557609" target="_blank" rel="noopener noreferrer" className={styles.whatsappBtn}>
                                ...
                                {t.rentPage.formWhatsappBtn}
                            </a>
                        </div>
                    </form>
                    <p className={styles.note}>{t.rentPage.formNote}</p>
                </div>
            </div>
        </section>
    );
