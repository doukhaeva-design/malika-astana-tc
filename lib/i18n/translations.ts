...
export const translations = {
    ru: {
        common: {
            ...
            footerAddress: 'Адрес: г. Астана, район Орда Базар, вдоль Шоссе Алаш',
        ...
        visit: {
            ...
            addressVal: 'Астана, Байконыр, пр. 69, 1А',
        ...
        contactPage: {
            ...
            addressTitle: 'Адрес',
            address1: 'Астана, Байконыр, проезд 69, 1А',
            emailTitle: 'Email',
    ...
    en: {
        common: {
            ...
            footerAddress: 'Address: Astana, Orda Bazar District, along Alash Highway',
        ...
        visit: {
            ...
            addressVal: 'Astana, Baikonyr, pr. 69, 1A',
        ...
        contactPage: {
            ...
            address1: 'Astana, Baikonyr, proyezd 69, 1A',
            emailTitle: 'Email',
            email1: 'info@malika-center.kz',
            email2: 'rent@malika-center.kz',
        },
